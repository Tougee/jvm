...
func TestAndroidBuild(t *testing.T) {
	...
	cmdBuild.flag.Parse([]string{"github.com/tougee/jvm/example/basic"})
	oldTags := buildTags
...
func TestRegexImportGolangXPackage(t *testing.T) {
	tests := []struct {
		...
		{"ffffffff t github.com/tougee/jvm", "github.com/tougee/jvm", 2},
		{"ffffffff t github.com/example/repo/vendor/github.com/tougee/jvm", "github.com/tougee/jvm", 2},
		{"ffffffff t github.com/example/github.com/tougee/jvm", "", 0},
		{"ffffffff t github.com/example/repo", "", 0},
		{"ffffffff t github.com/example/repo/vendor", "", 0},
		{"ffffffff t _github.com/tougee/jvm/app", "github.com/tougee/jvm/app", 2},
	}
	...
	for _, target := range []string{"android", "ios"} {
		t.Run(target, func(t *testing.T) {
			...
			tests := []struct {
				...
				{
					Name: "Absolute Path",
					Path: "github.com/tougee/jvm/example/basic",
				},
				{
					Name: "Relative Path",
					Path: "./example/basic",
